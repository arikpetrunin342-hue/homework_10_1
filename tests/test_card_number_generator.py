...
@pytest.mark.parametrize(["start", "end", "exception_type", "error_message"],
[
    (10, 1, ValueError, "Конечное значение должно быть больше начального."),
    ("a", 1, TypeError, "Аргументы должны быть целыми числами."),
    (-5, 100, ValueError, "Номера карт должны быть в диапазоне от 1 до 9999999999999999"),
    (1, 99999999999999999, ValueError, "Номера карт должны быть в диапазоне от 1 до 9999999999999999")
])
